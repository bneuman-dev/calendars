  ...
  (function($) {
    ...
    var eventData2 = {
      ...
      freebusys: [
        ...
        {'start': new Date(year, month, day, 8), 'end': new Date(year, month, day+0, 14), 'free': true, userId: [0,1,2,3]},
        {'start': new Date(year, month, day, 16), 'end': new Date(year, month, day+0, 18), 'free': true, userId: [0,1,2,3]},
